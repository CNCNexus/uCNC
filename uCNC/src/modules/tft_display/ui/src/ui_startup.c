...
void ui_startup_screen_init(void)
{
    ...
    ui_startup_image_logo = lv_image_create(ui_startup);
    lv_image_set_src(ui_startup_image_logo, &ui_img_ucnc_logo_png);
    lv_obj_set_width(ui_startup_image_logo, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_startup_image_logo, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_align(ui_startup_image_logo, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_startup_image_logo, LV_OBJ_FLAG_CLICKABLE);     /// Flags
    lv_obj_remove_flag(ui_startup_image_logo, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
